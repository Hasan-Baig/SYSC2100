...
public class CountSubstrings{
    ...
    */
    public void comparePattern(String pattern, String file) throws IOException, ClassNotFoundException{
        try {
        	Class cls = Class.forName("CountSubstrings");

            // returns the ClassLoader object associated with this Class
            ClassLoader cLoader = cls.getClassLoader();
            
            // input stream
            InputStream i = cLoader.getResourceAsStream(file);
